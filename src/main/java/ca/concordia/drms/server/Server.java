...
public class Server {
	public static void main( String [] args ) throws Exception{
		...
		for( String institution : names ){
			...
			pw.close();
			servant.getLogger().info( "registering -- " + institution + " --- reporting port "+ reportingSocket.getPort()+ " " + reportingSocket.getLocalPort() + " --- reservation port " + reservationSocket.getPort() );
